      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <Textarea id="description" value={form.description} onChange={handleChange} required />
          </div>
          <div>
            <Label htmlFor="duration">Durée (minutes)</Label>
            <Input id="duration" type="number" value={form.duration} onChange={handleChange} required />
          </div>
          <div>
          ...
          <div>
            ...
            <Input id="position" type="number" value={form.position} onChange={handleChange} required />
          </div>
          <div>
